...
Initial datasets downloaded: `activity_labels.txt`, `features.txt`, `features_info.txt`, `README.txt`, `X_test.txt`, `y_test.txt`, `X_train.txt`, `y_train.txt`, `subject_test.txt`, `subject_train.txt`.
